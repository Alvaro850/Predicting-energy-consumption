...
def createProbMatrix(N,M,X,Y,Head):
    prob = [1/2, 1/2, 0, 0]
    
    if Head == 'Norte': 
        if X in range(1,M-1) and Y in range(1,N-1):
            prob = [1/3,1/3,0,1/3] # Default probability 1/4
        # Upper-left corner
        elif X == 0 and Y == M-1 :       
            prob = [0, 1, 0, 0]
        # Upper-right corner
        ...
        # Bottom row
            ...
            prob = [0, 1/2, 0, 1/2]  #Can't go SOUTH
        # Left column
        elif X == 0 and Y in range(1,M-1):
            prob = [0, 1/2, 1/2, 0]    #Can't go WEST
        # Right column
        elif X == M-1 and Y in range(1,M-1):
            prob = [0, 0, 1/2, 1/2]  #Can't go EAST
    
    elif Head == 'Este':
        if X in range(1,M-1) and Y in range(1,N-1):
            prob = [1/3,1/3,1/3,0] # Default probability 1/4
        # Upper-left corner
        elif X == 0 and Y == M-1 :       
            prob = [0, 1/2, 1/2, 0]
        # Upper-right corner
        ...
        # Top row
            ...
            prob = [0, 1/2, 1/2, 0]    #Can't go NORTH
        # Bottom row
        elif X in range(1,M-1) and Y == 0:
            prob = [1/2, 1/2, 0, 0]  #Can't go SOUTH
        # Left column
        elif X == 0 and Y in range(1,M-1):
            prob = [1/3, 1/3, 1/3, 0]    #Can't go WEST
        # Right column
        elif X == M-1 and Y in range(1,M-1):
            prob = [1/2, 0, 1/2, 0]  #Can't go EAST
    
    elif Head == 'Oeste':
        if X in range(1,M-1) and Y in range(1,N-1):
            prob = [1/3, 0, 1/3, 1/3] # Default probability 1/4
        # Upper-left corner
        elif X == 0 and Y == M-1 :       
            prob = [0, 0, 1, 0]
        # Upper-right corner
        ...
        # Top row
            ...
            prob = [0, 0, 1/2, 1/2]    #Can't go NORTH
        # Bottom row
        elif X in range(1,M-1) and Y == 0:
            prob = [1/2, 0, 0, 1/2]  #Can't go SOUTH
        # Left column
        elif X == 0 and Y in range(1,M-1):
            prob = [1/2, 0, 1/2, 0]    #Can't go WEST
        # Right column
        elif X == M-1 and Y in range(1,M-1):
